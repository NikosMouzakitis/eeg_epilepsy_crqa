...
def main():
    ...
    recordings = [
        {
            "metadata_path": "p24_11_metadata.npy",
            "npy_path": "p24_11_filtered.npy",
            "segment_boundaries": [
                {'start_sample': 0, 'end_sample': 3527*256, 'label': 0},
                {'start_sample': 3527*256, 'end_sample': 3597*256, 'label': 1},
                {'start_sample': 3597*256, 'end_sample': None, 'label': 0}
            ]
        },

        {
            "metadata_path": "p24_13_metadata.npy",
            "npy_path": "p24_13_filtered.npy",
            "segment_boundaries": [
                {'start_sample': 0, 'end_sample': 3288*256, 'label': 0},
                {'start_sample': 3288*256, 'end_sample': 3304*256, 'label': 1},
                {'start_sample': 3304*256, 'end_sample': None, 'label': 0}
            ]
        },

        {
            "metadata_path": "p24_14_metadata.npy",
            "npy_path": "p24_14_filtered.npy",
            "segment_boundaries": [
                {'start_sample': 0, 'end_sample': 1939*256, 'label': 0},
                {'start_sample': 1939*256, 'end_sample': 1966*256, 'label': 1},
                {'start_sample': 1966*256, 'end_sample': None, 'label': 0}
            ]
        },
    ]
