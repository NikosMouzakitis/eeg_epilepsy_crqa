...
def false_nearest_neighbors(time_series, tau=1, max_dim=10, rtol=15.0, atol=2.0):
    """
    Correct implementation of False Nearest Neighbors algorithm based on:
...
if __name__ == "__main__":
    ...
    fnn_ratio, optimal_dim = false_nearest_neighbors( segment_data, tau=1, max_dim=15, rtol=15.0, atol=2.0)
    ...
    metrics, recurrence_matrix = calculate_rqa_metrics_custom( segment_data, m=optimal_dim, tau=tau, radius=0.035)
