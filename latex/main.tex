...
%			implementing RQA in a resource-constrained environment.
	...
	%		Also the described device adjusts or turns off the stimulation based on the patient's sleep state in order to save battery life and reduce side effects.
		...
		\section{Filtering}
			...
			manifest as sparse, high amplitude coefficients that can be 
	...
	\newpage
			...
			\section{Discussion}
The strong LOSO performance suggests that global CRQA statistics encode 
subject-independent seizure dynamics, supporting the hypothesis 
that seizures manifest as a macroscopic shift toward more deterministic 
and synchronized EEG activity rather than purely localized dynamics.			
