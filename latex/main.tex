...
\end{comment}
	...
	\newpage
			...
			The PyRQA library supports the computation of the following quantitative measures, as shown in Table~\ref{tab:pyrqa_metrics}:
		...
		For each segment and each pair of selected channels, the following steps were executed:
			...
			\begin{enumerate}
			    ...
			    \item \textbf{CRQA Computation}: Using the \texttt{PyRQA} library, a cross-recurrence plot is constructed 
					...
					The CRQA computation provides the 16 features as described in \ref{tab:rqa_metrics} 
