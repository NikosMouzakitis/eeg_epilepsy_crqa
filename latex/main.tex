...
%	\section{Introduction}
	...
	activity which result into 
	disturbances in behavior, sensation, movement and also in the consciousness
	of the affected subject. In general they affect
	...
	For the diagnosing epilepsy and monitoring the conddition, 
...
%	and developing reliable methods for automatic EEG analysis 
	...
	%\section{Related Work}
			...
			while seizure events took place, suggesting that these regions dominate the 
			network's dynamics.
