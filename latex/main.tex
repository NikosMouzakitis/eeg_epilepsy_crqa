...
%	\includegraphics[width=6cm]{ELMEPA.png}}\\[1cm]
	...
	\section{Related Work}
			...
			In their study, Mo et al.\cite{mo} used \textit{stereoelectroencephalography (sEEG)} 
			...
			Results highlighted the correlation among RQA measures 
		...
		\end{table}
			...
			proposed an alternative implementation of recurrence quantification metrics 
		...
		in each recording the following EEG signals
			...
			\begin{figure}[h]
			    ...
			    \caption{EEG electrode position namings.\cite{10-20-image}}
