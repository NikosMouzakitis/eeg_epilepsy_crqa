...
\end{comment}
	...
	\newpage
		...
		\subsubsection{Calculation of time delay \( \tau \) utilizing mutual information}
			...
			Figure \ref{fig:phase_space_3d} presents the reconstructed phase portrait for a normal EEG segment from channel 'Fp1-F7' from CHB-MIT 's chb24\_01.edf data.
