...
\end{comment}
	...
	\end{figure}
		...
		\subsection{Estimation of radius fraction R}
		...
		autocorrelated stochastic processes, while \cite{RhodesMorariFNN} showed that noise can lead to overestimation 
		of the embedding dimension. To mitigate these effects and maintain consistency across a 
		large dataset, the presented methodology adopts fixed values rather than optimizing the embedding parameters per recording.
