...
\begin{abstract}
	...
	in the reconstructed phase space, enabling the quantification of 
	...
	features have the ability to capture meaningful seizure related 
	dynamics and support the discrimination among epileptic and non-epileptic 
	EEG windows. 
	The findings point out the value that nonlinear inter-channel analysis holds
...
3  & Rezaei et al. (2023) & fMRI & RQA & Default model-like network, AD \\
...
%					suggests strong potential for subject-independent deployment.
					...
					and laminarity (LAM) 
					tend to increase during seizure segments, indicating the shift toward more 
					structured and 
					recurrent dynamics. 
